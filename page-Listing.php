...
?>
<?php get_header(); ?>
<body <?php body_class( $class = 'listingsPage' ); ?>>
			...
			<div class="page_content_wrapper">
				<div class="page_content_inner">
					<div class="left">
						...
						<?php the_field("list_features_listing"); ?>
					</div>
					<div class="right">
						<div class="proImg">
				...
				<div class="page_content_inner page_content_inner2">
					...
					<div class="right">
						...
						<?php the_field("list_features_listing2"); ?>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="machine_quote_wrapper">
				<div class="machine_quote_inner">
					<div class="left">
						...
						<div class="info">
							<h2>Direct links to seller Optimize search results</h2>
							<p>Boost your search engine presence by <br> listing your website inventory on Machine Lista</p>
						</div>
					</div>

					<div class="right">
						<a href="#" class="openLsFormPopup">
