	...
	<div class="fullWidth_wrapper searched_page_wrapper">
		...
		<div class="fullWidth_wrapper filterAndInfoWrapper">
			<div class="filterAndInfo">
				<ul>
					...
					?>
					<li style="opacity: 0;">Applicators Fertilizers</li>
					...
					<form action="<?php echo get_category_link($category->term_id); ?>" class="machine_filter">
						...
						<li class="fBycondition">
							...
							<button id="fCond">Condition <img src="https://machinelista.com/wp-content/themes/Used-Machine-SE/img/year-select.png" alt=""></button>
		...
		<div class="allSearchedProducts">
			<?php
				...
				} else if ($_GET['fYear'] && !empty($_GET['fYear'])) {
	...
	<script>
		$(document).ready(function() {
			...
			function loadMorePosts() {
			   ...
			   var isLoading = false;
			   var ajaxurl = "https://machinelista.com/wp-admin/admin-ajax.php";
